...
namespace Exo.WebApi.Contexts
{
    public class ExoContext : DbContext
    {
        ...
        optionsBuilder)
        {
            ...
            {
                // Essa string de conexão depende da SUA máquina. DESKTOP-O2BUSQP\SQLEXPRESS
                optionsBuilder.UseSqlServer("User ID = sa; Password = 2508; Server = DESKTOP-O2BUSQP\\SQLEXPRESS; Database = ExoApi; Trusted_Connection = False;");
